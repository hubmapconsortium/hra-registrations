...
def process_kpmp_csv(input_csv_path, output_yaml_path):
    ...
    df = df.dropna(subset=['filter active in Repository', 'filter active in Spatial Viewer','Formula: KPMP Atlas Spatial Viewer Link'])
...
#  Usage:
input_csv = "HuBMAP Healthy Tissue Registry - KPMP - Deep Links HRT.csv"
